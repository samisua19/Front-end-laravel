 ...
 <div class="form-group row">
    ...
    <div class="col-md-6">
        <input  id="identification_card" type="text" class="form-control @error('identification_card') is-invalid @enderror" identification_card="identification_card" value="{{ old('identification_card',$user->identification_card) }}" required autocomplete="identification_card" autofocus >
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" lastname="lastname" value="{{ old('lastname',$user->lastname) }}" required autocomplete="lastname" autofocus>
